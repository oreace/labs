	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<table id="events_table" data-toggle="table" data-url="app/events.php?action=fetch"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th>ID</th>
